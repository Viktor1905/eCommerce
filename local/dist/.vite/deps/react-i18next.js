...
var t = /\s([^'"/\s><]+?)[\s/>]|([^\s=]+)=\s?(".*?"|'.*?')/g;
function n(n2) {
  var r2 = { type: 'tag', name: '', voidElement: false, attrs: {}, children: [] },
    i2 = n2.match(/<\/?([^\s]+?)[/\s>]/);
  if (
    i2 &&
    ((r2.name = i2[1]),
      ...
      return (
        (e2 +=
          ...
          (t2.attrs
            ...
            : '') +
          (t2.voidElement ? '/>' : '>')),
        t2.voidElement ? e2 : e2 + t2.children.reduce(a, '') + '</' + t2.name + '>'
      );
    case 'comment':
        ...
        if (
          (f &&
            ...
            a2.voidElement ||
              ...
              !d ||
              '<' === d ||
              a2.children.push({ type: 'text', content: e2.slice(p, e2.indexOf('<', p)) }),
            0 === l && c2.push(a2),
          ...
          i.test(g) && (g = ' '),
            ((x > -1 && l + u2.length >= 0) || ' ' !== g) && u2.push({ type: 'text', content: g });
        }
      }),
      c2
    );
...
var warn = (i18n, code, msg, rest) => {
  ...
  if (
    (_b = (_a = i18n == null ? void 0 : i18n.services) == null ? void 0 : _a.logger) == null
      ? void 0
      : _b.forward
  ) {
  ...
  if (
    (_d = (_c = i18n == null ? void 0 : i18n.services) == null ? void 0 : _c.logger) == null
      ? void 0
      : _d.warn
  ) {
...
var hasLoadedNamespace = (ns, i18n, options = {}) => {
  ...
  return i18n.hasLoadedNamespace(ns, {
    ...
    precheck: (i18nInstance2, loadNotPending) => {
      var _a;
      if (
        ((_a = options.bindI18n) == null ? void 0 : _a.indexOf('languageChanging')) > -1 &&
...
var getChildren = (node) => {
  ...
  return ((_b = node.props) == null ? void 0 : _b.i18nIsDynamicList)
    ? getAsArray(children)
    : children;
};
var hasValidReactChildren = (children) =>
  Array.isArray(children) && children.every(import_react.isValidElement);
...
var nodesToString = (children, i18nOptions, i18n, i18nKey) => {
  ...
  const keepArray = (i18nOptions == null ? void 0 : i18nOptions.transSupportBasicHtmlNodes)
...
var renderNodes = (children, targetString, i18n, i18nOptions, combinedTOpts, shouldUnescape) => {
  ...
  const renderInner = (child, node, rootReactNode) => {
    ...
    return (hasValidReactChildren(childs) && mappedChildren.length === 0) ||
      ((_a = child.props) == null ? void 0 : _a.i18nIsDynamicList)
      ? childs
      : mappedChildren;
  };
  const pushTranslatedJSX = (child, inner, mem, i2, isVoid) => {
    if (child.dummy) {
      ...
      mem.push(
        ...import_react.Children.map([child], (c2) => {
          const props = {
            ...c2.props,
          };
  ...
  const mapAST = (reactNode, astNode, rootReactNode) => {
    ...
    return astNodes.reduce((mem, node, i2) => {
      ...
      const translationContent =
        ((_b = (_a = node.children) == null ? void 0 : _a[0]) == null ? void 0 : _b.content) &&
...
var generateArrayComponents = (components, translation) =>
  components.map((c2, index) => fixComponentProps(c2, index, translation));
...
function Trans({
  ...
  if (
    (_d = (_c = i18n.options) == null ? void 0 : _c.interpolation) == null
      ? void 0
      : _d.defaultVariables
  ) {
    values =
  ...
  const interpolationOverride =
    values ||
    (count !== void 0 &&
      !((_f = (_e = i18n.options) == null ? void 0 : _e.interpolation) == null
        ? void 0
        : _f.alwaysFormat)) ||
    !children
...
var composeInitialProps = (ForComponent) => async (ctx) => {
  ...
  const componentsInitialProps =
    (await ((_a = ForComponent.getInitialProps) == null ? void 0 : _a.call(ForComponent, ctx))) ??
    {};
...
function Trans2({
  ...
  return Trans({
    ...
    ns:
      ns ||
      (t2 == null ? void 0 : t2.ns) ||
      defaultNSFromContext ||
      ((_a = i18n == null ? void 0 : i18n.options) == null ? void 0 : _a.defaultNS),
    i18n,
    t: tFromProps,
    shouldUnescape,
    ...additionalProps,
...
var alwaysNewT = (i18n, language, namespace, keyPrefix) =>
  i18n.getFixedT(language, namespace, keyPrefix);
var useMemoizedT = (i18n, language, namespace, keyPrefix) =>
  (0, import_react4.useCallback)(alwaysNewT(i18n, language, namespace, keyPrefix), [
    i18n,
    language,
    namespace,
    keyPrefix,
...
var useTranslation = (ns, props = {}) => {
  ...
  let namespaces =
    ns || defaultNSFromContext || ((_b = i18n.options) == null ? void 0 : _b.defaultNS);
  namespaces = isString(namespaces) ? [namespaces] : namespaces || ['translation'];
  ...
  const ready =
    ...
    namespaces.every((n2) => hasLoadedNamespace(n2, i18n, i18nOptions));
...
var withTranslation = (ns, options = {}) =>
