import { appendErrors, get, set } from './chunk-KYMJZENY.js';
...
var o = (e, t) => {
  for (const o2 in t.fields) {
    ...
    s3 && s3.ref && 'reportValidity' in s3.ref
      ? r(s3.ref, o2, e)
      : s3 && s3.refs && s3.refs.forEach((t2) => r(t2, o2, e));
  }
};
var s = (r2, s3) => {
  ...
  const n3 = {};
  for (const o2 in r2) {
    const f = get(s3.fields, o2),
      c = Object.assign(r2[o2] || {}, { ref: f && f.ref });
...
function n2(r2, e) {
  for (var n3 = {}; r2.length; ) {
    ...
    if (
      ('unionErrors' in s3 &&
        s3.unionErrors.forEach(function (e2) {
    ...
    function (i2, a, u) {
      try {
        return Promise.resolve(
          (function (e, n3) {
            try {
              var a2 = Promise.resolve(o2['sync' === t.mode ? 'parse' : 'parseAsync'](i2, s3)).then(
                function (e2) {
                  return (
                    u.shouldUseNativeValidation && o({}, u),
                    { errors: {}, values: t.raw ? Object.assign({}, i2) : e2 }
                  );
                }
              );
            } catch (r2) {
            ...
            if (
              ...
              return {
                values: {},
                errors: s(
                  n2(r2.errors, !u.shouldUseNativeValidation && 'all' === u.criteriaMode),
                  u
                ),
              };
            throw r2;
