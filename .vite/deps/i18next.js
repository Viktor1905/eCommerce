...
var consoleLogger = {
  ...
  output(type, args) {
    var _a, _b;
    (_b = (_a = console == null ? void 0 : console[type]) == null ? void 0 : _a.apply) == null
      ? void 0
      : _b.call(_a, console, args);
  },
};
...
var ResourceStore = class extends EventEmitter {
  ...
  getResource(lng, ns, key) {
    ...
    const keySeparator =
      options2.keySeparator !== void 0 ? options2.keySeparator : this.options.keySeparator;
    const ignoreJSONStructure =
      options2.ignoreJSONStructure !== void 0
        ? options2.ignoreJSONStructure
    ...
    return deepFind(
      (_b = (_a = this.data) == null ? void 0 : _a[lng]) == null ? void 0 : _b[ns],
      key,
      keySeparator
    );
  }
...
var postProcessor = {
  ...
  handle(processors, value, key, options2, translator) {
    processors.forEach((processor) => {
      var _a;
      value =
        ((_a = this.processors[processor]) == null
          ? void 0
          : _a.process(value, key, options2, translator)) ?? value;
    });
    return value;
  },
};
  ...
  extendTranslation(res, key, opt, resolved, lastKey) {
    ...
    if ((_a = this.i18nFormat) == null ? void 0 : _a.parse) {
      ...
      const skipOnVariables =
        isString(res) &&
        (((_b = opt == null ? void 0 : opt.interpolation) == null ? void 0 : _b.skipOnVariables) !==
        void 0
    ...
    if (
      res != null &&
      (postProcessorNames == null ? void 0 : postProcessorNames.length) &&
    ...
    keys.forEach((k) => {
      ...
      namespaces.forEach((ns) => {
        ...
        if (
          ...
          ((_a = this.utils) == null ? void 0 : _a.hasLoadedNamespace) &&
          !((_b = this.utils) == null ? void 0 : _b.hasLoadedNamespace(usedNS))
        ) {
...
var Interpolator = class {
  constructor() {
    ...
    this.options = options2;
    this.format =
      ((_a = options2 == null ? void 0 : options2.interpolation) == null ? void 0 : _a.format) ||
      ((value) => value);
    this.init(options2);
  }
  init() {
  ...
  interpolate(str, data, lng, options2) {
    ...
    const missingInterpolationHandler =
      (options2 == null ? void 0 : options2.missingInterpolationHandler) ||
      this.options.missingInterpolationHandler;
    const skipOnVariables =
      ((_a = options2 == null ? void 0 : options2.interpolation) == null
        ? void 0
        : _a.skipOnVariables) !== void 0
  ...
  nest(str, fc) {
    ...
    const handleHasOptions = (key, inheritedOptions) => {
      ...
      if (
        (((matchedSingleQuotes == null ? void 0 : matchedSingleQuotes.length) ?? 0) % 2 === 0 &&
          !matchedDoubleQuotes) ||
...
var createCachedFormatter = (fn) => {
  ...
  return (val, lng, options2) => {
    ...
    if (
      options2 &&
      options2.interpolationkey &&
      options2.formatParams &&
      options2.formatParams[options2.interpolationkey] &&
      options2[options2.interpolationkey]
    ) {
      optForCache = {
        ...optForCache,
  ...
  format(value, format, lng) {
    ...
    const result = formats.reduce((mem, f) => {
      ...
      if (this.formats[formatName]) {
        ...
        try {
          const valOptions =
            ((_a = options2 == null ? void 0 : options2.formatParams) == null
              ? void 0
              : _a[options2.interpolationkey]) || {};
...
var Connector = class extends EventEmitter {
  constructor(backend, store, services) {
    ...
    this.state = {};
    this.queue = [];
    (_b = (_a = this.backend) == null ? void 0 : _a.init) == null
      ? void 0
      : _b.call(_a, services, options2.backend, options2);
  }
  ...
  saveMissing(languages, namespace, key, fallbackValue, isUpdate) {
    ...
    if (
      ((_b = (_a = this.services) == null ? void 0 : _a.utils) == null
        ? void 0
        : _b.hasLoadedNamespace) &&
      !((_d = (_c = this.services) == null ? void 0 : _c.utils) == null
        ? void 0
        : _d.hasLoadedNamespace(namespace))
    ) {
      this.logger.warn(
...
var transformOptions = (options2) => {
  ...
  if (
    ((_b = (_a = options2.supportedLngs) == null ? void 0 : _a.indexOf) == null
      ? void 0
      : _b.call(_a, 'cimode')) < 0
  ) {
...
var I18n = class _I18n extends EventEmitter {
  ...
  loadResources(language) {
    ...
    if (!this.options.resources || this.options.partialBundledLanguages) {
      if (
        (usedLng == null ? void 0 : usedLng.toLowerCase()) === 'cimode' &&
      ...
      (_b = (_a = this.options.preload) == null ? void 0 : _a.forEach) == null
        ? void 0
        : _b.call(_a, (l) => append(l));
  ...
  changeLanguage(lng, callback) {
    ...
    const setLng = (lngs) => {
      ...
      if (l) {
        ...
        (_b = (_a = this.services.languageDetector) == null ? void 0 : _a.cacheUserLanguage) == null
          ? void 0
          : _b.call(_a, l);
      }
  ...
  dir(lng) {
    ...
    if (!lng)
      lng =
        this.resolvedLanguage ||
        (((_a = this.languages) == null ? void 0 : _a.length) > 0
          ? this.languages[0]
          : this.language);
    if (!lng) return 'rtl';
    const rtlLngs = [
    ...
    const languageUtils =
      ((_b = this.services) == null ? void 0 : _b.languageUtils) || new LanguageUtil(get());
