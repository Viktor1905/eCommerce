import { require_jsx_runtime } from './chunk-NX324PME.js';
...
var OnlineManager =
  ((_a2 = class extends Subscribable {
    constructor() {
      super();
    ...
    fetch(options, fetchOptions) {
      ...
      const onError = (error) => {
        ...
        if (!isCancelledError(error)) {
          (_b2 = (_a13 = __privateGet(this, _cache).config).onError) == null
            ? void 0
            : _b2.call(_a13, error, this);
          (_d = (_c2 = __privateGet(this, _cache).config).onSettled) == null
            ? void 0
            : _d.call(_c2, this.state.data, error, this);
        }
        this.scheduleGc();
      };
      __privateSet(
        ...
        createRetryer({
          ...
          onSuccess: (data) => {
            ...
            (_d = (_c2 = __privateGet(this, _cache).config).onSettled) == null
              ? void 0
              : _d.call(_c2, data, this.state.error, this);
            this.scheduleGc();
          },
          onError,
...
var _queries, _a5;
var QueryCache =
  ((_a5 = class extends Subscribable {
    constructor(config = {}) {
      super();
...
var Mutation =
  ((_a6 = class extends Removable {
    ...
    continue() {
      var _a12;
      return (
        ((_a12 = __privateGet(this, _retryer2)) == null ? void 0 : _a12.continue()) ?? // continuing a mutation assumes that variables are set, mutation must have been dehydrated before
    ...
    async execute(variables) {
      ...
      try {
        ...
        await ((_f = (_e = __privateGet(this, _mutationCache).config).onSuccess) == null
          ? void 0
          : _f.call(_e, data, variables, this.state.context, this));
        ...
        await ((_j = (_i = __privateGet(this, _mutationCache).config).onSettled) == null
          ? void 0
          : _j.call(_i, data, null, this.state.variables, this.state.context, this));
        ...
        try {
          ...
          await ((_r = (_q = __privateGet(this, _mutationCache).config).onSettled) == null
            ? void 0
            : _r.call(_q, void 0, error, this.state.variables, this.state.context, this));
...
var MutationCache =
  ((_a7 = class extends Subscribable {
    constructor(config = {}) {
      super();
    ...
    runNext(mutation) {
      ...
      if (typeof scope === 'string') {
        const foundMutation =
          (_a12 = __privateGet(this, _scopes).get(scope)) == null
            ? void 0
...
function infiniteQueryBehavior(pages) {
  return {
    onFetch: (context, query) => {
      ...
      const direction =
        (_c =
          (_b = (_a12 = context.fetchOptions) == null ? void 0 : _a12.meta) == null
            ? void 0
            : _b.fetchMore) == null
          ? void 0
          : _c.direction;
      ...
      if (context.options.persister) {
        context.fetchFn = () => {
          var _a13, _b2;
          return (_b2 = (_a13 = context.options).persister) == null
            ? void 0
            : _b2.call(
                _a13,
                fetchFn,
  ...
  ((_a9 = class extends Subscribable {
    ...
    setOptions(options) {
      ...
      if (
        ...
        typeof resolveEnabled(this.options.enabled, __privateGet(this, _currentQuery)) !== 'boolean'
      ) {
...
var MutationObserver =
  ...
  (updateResult_fn = function () {
    var _a12;
    const state =
      ((_a12 = __privateGet(this, _currentMutation)) == null ? void 0 : _a12.state) ??
      getDefaultState2();
      ...
      if (__privateGet(this, _mutateOptions) && this.hasListeners()) {
        ...
        if ((action == null ? void 0 : action.type) === 'success') {
          ...
          (_h = (_g = __privateGet(this, _mutateOptions)).onSettled) == null
            ? void 0
            : _h.call(_g, void 0, action.error, variables, context);
        }
      }
      this.listeners.forEach((listener) => {
...
function streamedQuery({ queryFn, refetchMode = 'reset' }) {
...
function useQueries({ queries, ...options }, queryClient) {
  ...
  React5.useSyncExternalStore(
    React5.useCallback(
      (onStoreChange) =>
        shouldSubscribe ? observer.subscribe(notifyManager.batchCalls(onStoreChange)) : noop2,
...
function useBaseQuery(options, Observer, queryClient) {
  ...
  (_b =
    (_a12 = client.getDefaultOptions().queries) == null
      ? void 0
      : _a12._experimental_beforeQuery) == null
    ? void 0
    : _b.call(_a12, defaultedOptions);
  if (true) {
  ...
  (_d = (_c = client.getDefaultOptions().queries) == null ? void 0 : _c._experimental_afterQuery) ==
  null
    ? void 0
      ...
      for (const dehydratedQuery of queries) {
        ...
        if (!existingQuery) {
          ...
          const hydrationIsNewer =
            dehydratedQuery.state.dataUpdatedAt > existingQuery.state.dataUpdatedAt || // RSC special serialized then-able chunks
          ...
          const queryAlreadyQueued =
            hydrationQueue == null
              ? void 0
              : hydrationQueue.find((query) => query.queryHash === dehydratedQuery.queryHash);
          if (
            hydrationIsNewer &&
            (!queryAlreadyQueued ||
              dehydratedQuery.state.dataUpdatedAt > queryAlreadyQueued.state.dataUpdatedAt)
          ) {
