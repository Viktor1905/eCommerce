import { require_react } from './chunk-Z4L4S4OG.js';
import {
  addDays,
  addMonths,
  addWeeks,
  ...
  startOfWeek,
  startOfYear,
} from './chunk-MDLZPXGZ.js';
import { __export, __toESM } from './chunk-WOOG5QLI.js';
...
function getBroadcastWeeksInMonth(month, dateLib2) {
  ...
  const numberOfWeeks =
    dateLib2.getMonth(month) === dateLib2.getMonth(lastDateOfLastWeek) ? FIVE_WEEKS : FOUR_WEEKS;
...
var DateLib = class {
  ...
  constructor(options, overrides) {
    ...
    this.eachMonthOfInterval = (interval) => {
      var _a;
      return ((_a = this.overrides) == null ? void 0 : _a.eachMonthOfInterval)
    ...
    this.format = (date, formatStr) => {
      var _a;
      const formatted = ((_a = this.overrides) == null ? void 0 : _a.format)
    ...
    this.getMonth = (date) => {
      var _a;
      return ((_a = this.overrides) == null ? void 0 : _a.getMonth)
        ? this.overrides.getMonth(date, this.options)
        : getMonth(date, this.options);
    };
    this.getYear = (date) => {
      var _a;
      return ((_a = this.overrides) == null ? void 0 : _a.getYear)
...
function Nav(props) {
  ...
  const handlePreviousClick = (0, import_react15.useCallback)(
    (e) => {
      if (previousMonth) {
...
function getMonthOptions(displayMonth, navStart, navEnd, formatters, dateLib2) {
  const {
    ...
    eachMonthOfInterval: eachMonthOfInterval2,
    getMonth: getMonth2,
  } = dateLib2;
  ...
  const options = months.map((month) => {
    ...
    const disabled =
      (navStart && month < startOfMonth2(navStart)) ||
      (navEnd && month > startOfMonth2(navEnd)) ||
      false;
...
function getWeekdays(dateLib2, ISOWeek, broadcastCalendar) {
  ...
  const start = broadcastCalendar
    ? dateLib2.startOfBroadcastWeek(today, dateLib2)
    : ISOWeek
      ? dateLib2.startOfISOWeek(today)
      : dateLib2.startOfWeek(today);
  const days = [];
  for (let i = 0; i < 7; i++) {
...
function useAnimation(rootElRef, enabled, { classNames, months, focused, dateLib: dateLib2 }) {
  ...
  (0, import_react28.useLayoutEffect)(() => {
    ...
    if (
      ...
      isSameMonth2 || // skip animation if a day is focused because it can cause issues to the animation and is better for a11y
      focused
    ) {
      return;
    }
  ...
  for (const day of days) {
    ...
    if (isFocusableDay(modifiers)) {
      if (
        ...
        (lastFocused == null ? void 0 : lastFocused.isEqualTo(day)) &&
...
function getNextFocus(
  ...
  const isDisabled = Boolean(
    props.disabled && dateMatchModifiers(focusableDate, props.disabled, dateLib2)
  );
...
function DayPicker(props) {
  ...
  const weekdays = (0, import_react32.useMemo)(
    () => getWeekdays(dateLib2, props.ISOWeek),
    [dateLib2, props.ISOWeek]
  );
  ...
  const handleDayClick = (0, import_react32.useCallback)(
    (day, m) => (e) => {
      e.preventDefault();
      e.stopPropagation();
      setFocused(day);
  ...
  const handleDayFocus = (0, import_react32.useCallback)(
    (day, m) => (e) => {
      setFocused(day);
  ...
  const handleDayBlur = (0, import_react32.useCallback)(
    (day, m) => (e) => {
      blur();
  ...
  const handleDayKeyDown = (0, import_react32.useCallback)(
    (day, modifiers) => (e) => {
      const keyMap = {
  ...
  const handleDayMouseEnter = (0, import_react32.useCallback)(
    (day, modifiers) => (e) => {
      onDayMouseEnter == null ? void 0 : onDayMouseEnter(day.date, modifiers, e);
    },
    [onDayMouseEnter]
  );
  const handleDayMouseLeave = (0, import_react32.useCallback)(
    (day, modifiers) => (e) => {
      onDayMouseLeave == null ? void 0 : onDayMouseLeave(day.date, modifiers, e);
    },
    [onDayMouseLeave]
  );
  const handleMonthChange = (0, import_react32.useCallback)(
    (date) => (e) => {
  ...
  const handleYearChange = (0, import_react32.useCallback)(
    (date) => (e) => {
    ...
    import_react32.default.createElement(
      ...
      import_react32.default.createElement(
        ...
        !props.hideNavigation &&
          import_react32.default.createElement(components.Nav, {
        ...
        months.map((calendarMonth, displayIndex) => {
          ...
          return import_react32.default.createElement(
            ...
            import_react32.default.createElement(
              ...
              (captionLayout == null ? void 0 : captionLayout.startsWith('dropdown'))
                ? import_react32.default.createElement(
                    ...
                    captionLayout === 'dropdown' || captionLayout === 'dropdown-months'
                      ? import_react32.default.createElement(components.MonthsDropdown, {
                          ...
                          style: styles == null ? void 0 : styles[UI.Dropdown],
                          value: dateLib2.getMonth(calendarMonth.date),
                        })
                      : import_react32.default.createElement(
                          'span',
                          null,
                          formatMonthDropdown2(calendarMonth.date, dateLib2)
                        ),
                    captionLayout === 'dropdown' || captionLayout === 'dropdown-years'
                      ? import_react32.default.createElement(components.YearsDropdown, {
                          ...
                          style: styles == null ? void 0 : styles[UI.Dropdown],
                          value: dateLib2.getYear(calendarMonth.date),
                        })
                      : import_react32.default.createElement(
                          'span',
                          null,
                          formatYearDropdown2(calendarMonth.date, dateLib2)
                        ),
                    import_react32.default.createElement(
                      'span',
                      {
            ...
            import_react32.default.createElement(
              components.MonthGrid,
              {
                ...
                'aria-label': labelGrid2(calendarMonth.date, dateLib2.options, dateLib2) || void 0,
                ...
                import_react32.default.createElement(
                  ...
                  showWeekNumber &&
                    import_react32.default.createElement(
                      components.WeekNumberHeader,
                      {
                        ...
                        style: styles == null ? void 0 : styles[UI.WeekNumberHeader],
                        scope: 'col',
                      },
                  ...
                  weekdays.map((weekday, i) =>
                    import_react32.default.createElement(
                      components.Weekday,
                      {
                        'aria-label': labelWeekday2(weekday, dateLib2.options, dateLib2),
                  ...
                  return import_react32.default.createElement(
                    ...
                    showWeekNumber &&
                      import_react32.default.createElement(
                        ...
                        {
                          week,
                          style: styles == null ? void 0 : styles[UI.WeekNumber],
                          'aria-label': labelWeekNumber2(week.weekNumber, {
                            locale,
                          }),
                        ...
                        formatWeekNumber2(week.weekNumber)
                      ),
                    week.days.map((day) => {
                      const { date } = day;
                      const modifiers = getModifiers(day);
                      modifiers[DayFlag.focused] =
                        !modifiers.hidden &&
                        Boolean(focused == null ? void 0 : focused.isEqualTo(day));
                      modifiers[SelectionState.selected] =
                        (isSelected == null ? void 0 : isSelected(date)) || modifiers.selected;
                      ...
                      const ariaLabel =
                        !isInteractive && !modifiers.hidden
                          ? labelGridcell2(date, modifiers, dateLib2.options, dateLib2)
                          : void 0;
                      return import_react32.default.createElement(
                        components.Day,
                        {
                          ...
                          'data-month': day.outside ? dateLib2.format(date, 'yyyy-MM') : void 0,
                        ...
                        !modifiers.hidden && isInteractive
                          ? import_react32.default.createElement(
                              components.DayButton,
                              {
                                ...
                                style: styles == null ? void 0 : styles[UI.DayButton],
                                type: 'button',
                                day,
                                modifiers,
                          ...
                          : !modifiers.hidden && formatDay2(day.date, dateLib2.options, dateLib2)
                      );
                    })
                  );
                })
