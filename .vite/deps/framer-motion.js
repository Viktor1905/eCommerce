...
import { __commonJS, __export, __toESM } from './chunk-WOOG5QLI.js';
...
function test(v) {
  ...
  return (
    isNaN(v) &&
    typeof v === 'string' &&
    (((_a = v.match(floatRegex)) == null ? void 0 : _a.length) || 0) +
...
var NativeAnimation = class extends WithPromise {
  ...
  get duration() {
    var _a, _b;
    const duration =
      ((_b = (_a = this.animation.effect) == null ? void 0 : _a.getComputedTiming) == null
        ? void 0
        : _b.call(_a).duration) || 0;
...
function filterViewAnimations(animation) {
  ...
  return (
    ...
    ((_a = effect.pseudoElement) == null ? void 0 : _a.startsWith('::view-transition'))
  );
}
...
function scrapeMotionValuesFromProps(props, prevProps, visualElement) {
  ...
  for (const key in style2) {
    if (
      ...
      ((_a = visualElement == null ? void 0 : visualElement.getValue(key)) == null
        ? void 0
        : _a.liveStyle) !== void 0
    ) {
    ...
    const resumeAnimation = () =>
      eachAxis((axis) => {
        ...
        return (
          ...
          ((_a = this.getAxisMotionValue(axis).animation) == null ? void 0 : _a.play())
        );
      });
  ...
  return class ProjectionNode {
    ...
    measurePageBox() {
      ...
      const wasInScrollRoot =
        ((_a = this.scroll) == null ? void 0 : _a.wasRoot) ||
    ...
    resolveTargetDelta(forceRecalculation = false) {
      ...
      const canSkip = !(
        ...
        ((_a = this.parent) == null ? void 0 : _a.isProjectionDirty) ||
  ...
  getBaseTarget(key) {
    ...
    if (typeof initial === 'string' || typeof initial === 'object') {
      const variant = resolveVariantFromProps(
        this.props,
        initial,
        (_a = this.presenceContext) == null ? void 0 : _a.custom
      );
      if (variant) {
...
function notifyTarget({ target, contentRect, borderBoxSize }) {
  var _a;
  (_a = resizeHandlers.get(target)) == null
    ? void 0
    : _a.forEach((handler) => {
        handler({
          target,
...
function useSpring(source, config = {}) {
  ...
  const unit = useConstant(() =>
    typeof initialValue === 'string' ? initialValue.replace(/[\d.-]/g, '') : void 0
  );
...
function handoffOptimizedAppearAnimation(elementId, valueName, frame2) {
  ...
  if (
    startTime === null ||
    ((_a = window.MotionHandoffIsComplete) == null ? void 0 : _a.call(window, elementId))
  ) {
    cancelAnimation();
    return null;
  } else {
  ...
  if (!readyAnimation) {
    ...
    window.MotionCheckAppearSync = (visualElement, valueName, value) => {
      ...
      const valueIsOptimised =
        (_a = window.MotionHasOptimisedAnimation) == null
          ? void 0
          : _a.call(window, appearId, valueName);
      const externalAnimationValue =
        (_b = visualElement.props.values) == null ? void 0 : _b[valueName];
