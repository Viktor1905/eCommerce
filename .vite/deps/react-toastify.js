...
function $({
  ...
  return function ({
    ...
    return (
      ...
      import_react2.default.createElement(import_react2.default.Fragment, null, a)
    );
  };
}
function J(t, o) {
...
function tt(t, o, e = false) {
  return (0, import_react3.isValidElement)(t) && !N(t.type)
    ? (0, import_react3.cloneElement)(t, {
    ...
    : P(t)
      ? t({ closeToast: o.closeToast, toastProps: o, data: o.data, isPaused: e })
      : t;
}
...
function gt({
  ...
  let v = s || (a && d === 0),
    x = { animationDuration: `${t}ms`, animationPlayState: o ? 'running' : 'paused' };
  ...
  let C = clsx_default(
      ...
      `Toastify__progress-bar--${r2}`,
      { ['Toastify__progress-bar--rtl']: c }
    ),
    S = P(l) ? l({ rtl: c, type: r2, defaultClassName: C }) : clsx_default(C, l),
    E = {
  ...
  return import_react5.default.createElement(
    ...
    import_react5.default.createElement('div', {
      className: `Toastify__progress-bar--bg Toastify__progress-bar-theme--${g} Toastify__progress-bar--${r2}`,
    }),
    import_react5.default.createElement('div', {
      role: 'progressbar',
  ...
  return {
    ...
    buildToast: (i, n) => {
      ...
      let A = {
        ...
        autoClose: n.isLoading ? false : pt(n.autoClose, d.autoClose),
        closeToast(D) {
      ...
      (A.closeButton = d.closeButton),
        n.closeButton === false || z(n.closeButton)
          ? (A.closeButton = n.closeButton)
          : n.closeButton === true && (A.closeButton = z(d.closeButton) ? d.closeButton : true);
...
y.update = (t, o = {}) => {
  let e = vt(t, o);
  if (e) {
    let { props: r2, content: s } = e,
      l = { delay: 100, ...r2, ...o, toastId: o.toastId || t, updateId: at() };
...
function At(t) {
  let [o, e] = (0, import_react8.useState)(false),
    [r2, s] = (0, import_react8.useState)(false),
    l = (0, import_react8.useRef)(null),
    a = (0, import_react8.useRef)({
      start: 0,
      delta: 0,
      removalDistance: 0,
  ...
  xt({ id: t.toastId, containerId: t.containerId, fn: e }),
  ...
  function S(m) {
    if (t.draggable === true || t.draggable === m.pointerType) {
      b();
      let _ = l.current;
      (a.canCloseOnClick = true),
        (a.canDrag = true),
        (_.style.transition = 'none'),
        t.draggableDirection === 'x'
          ? ((a.start = m.clientX),
            (a.removalDistance = _.offsetWidth * (t.draggablePercent / 100)))
          : ((a.start = m.clientY),
            (a.removalDistance =
              (_.offsetHeight *
  ...
  function n(m) {
    ...
    if (a.canDrag && _) {
      (a.didMove = true),
        o && p(),
        t.draggableDirection === 'x'
          ? (a.delta = m.clientX - a.start)
          : (a.delta = m.clientY - a.start),
        a.start !== m.clientX && (a.canCloseOnClick = false);
      let k =
        t.draggableDirection === 'x'
          ? `${a.delta}px, var(--y)`
...
var G = ({ theme: t, type: o, isLoading: e, ...r2 }) =>
...
function Nt({ theme: t, type: o, isLoading: e, icon: r2 }) {
  ...
  return (
    r2 === false ||
      (P(r2)
        ? (s = r2({ ...l, isLoading: e }))
        : (0, import_react11.isValidElement)(r2)
          ? (s = (0, import_react11.cloneElement)(r2, l))
          : e
            ? (s = W.spinner())
            : lo(o) && (s = W[o](l))),
    s
...
var wt = (t) => {
  let {
    ...
    Y = P(E) ? E({ rtl: u, position: S, type: g, defaultClassName: D }) : clsx_default(D, E),
    ft = Nt(t),
    dt = !!n || !c,
    j = { closeToast: x, type: g, theme: A },
    H = null;
  return (
    a === false ||
      (P(a)
        ? (H = a(j))
        : (0, import_react10.isValidElement)(a)
          ? (H = (0, import_react10.cloneElement)(a, j))
          : (H = yt(j))),
    import_react10.default.createElement(
      C,
      { isIn: _, done: m, position: S, preventExitTransition: e, nodeRef: r2, playToast: l },
      import_react10.default.createElement(
        'div',
        {
          id: h,
          ...
          style: f,
          ref: r2,
          ...(_ && { role: i, 'aria-label': R }),
        },
        ft != null &&
          import_react10.default.createElement(
            'div',
            {
              className: clsx_default('Toastify__toast-icon', {
        ...
        H,
        !t.customProgressBar &&
          import_react10.default.createElement(gt, {
            ...(b && !dt ? { key: `p-${b}` } : {}),
            rtl: u,
            theme: A,
            delay: c,
...
function Lt(t) {
  let o = { ..._o, ...t },
    e = t.stacked,
    [r2, s] = (0, import_react6.useState)(true),
    l = (0, import_react6.useRef)(null),
    { getToastToRender: a, isToastActive: d, count: c } = It(o),
    { className: T, style: g, rtl: v, containerId: x, hotKeys: C } = o;
  function S(f) {
    let p = clsx_default('Toastify__toast-container', `Toastify__toast-container--${f}`, {
  ...
  return (
    ...
    (0, import_react6.useEffect)(() => {
      function f(p) {
        var i;
        let b = l.current;
        C(p) && ((i = b.querySelector('[tabIndex="0"]')) == null || i.focus(), s(false), y.pause()),
          p.key === 'Escape' &&
    ...
    import_react6.default.createElement(
      ...
      a((f, p) => {
        ...
        return import_react6.default.createElement(
          'div',
          { tabIndex: -1, className: S(f), 'data-stacked': e, style: b, key: `c-${f}` },
